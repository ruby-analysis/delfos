...
describe Delfos::FileSystem::Relation do
  describe "#others" do
    ...
    context "with a file" do
      let(:path) { t("tree/another_top_level_file") }
...
describe Delfos::FileSystem::Relation do
  ...
  context "traversing all files" do
    let(:a) { t("tree/sub_directory/some_more") }
    let(:b) { t("tree/sub_directory") }
  ...
  context "traversing down all directories" do
    let(:a) { t("tree/sub_directory/another_directory") }
  ...
  context "traversing down some directories" do
    let(:a) { t("tree/sub_directory/second_level") }
    let(:b) { t("tree/sub_directory/yet_another_directory") }
