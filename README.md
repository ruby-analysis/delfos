...
# Functionality
  * Record runtime type information and call site file locations in most ruby programs
  * Zero ruby dependencies (just a dependency on an HTTP connection to a neo4j instance)
...
# You could now click around the app or run integration tests to record type information
```

### Options
Delfos.setup!  logger: Delfos::Neo4j::Informer.new,
